...
# One-hot encode for XGBoost (no native categorical support)
...
output_dir = r'D:\PhD work\Objective 2\FE modelling\ML Modelling\Trial 2_additional inputs\XGBoost'
os.makedirs(output_dir, exist_ok=True)
output_file = os.path.join(output_dir, 'XGBoost_regression_100runs_refined.xlsx')
